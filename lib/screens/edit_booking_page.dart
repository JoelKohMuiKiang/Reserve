...
class EditBookingsPage extends StatefulWidget {
  static String routeName = '/editbookings';

  @override
  State<EditBookingsPage> createState() => _EditBookingsPageState();
}

class _EditBookingsPageState extends State<EditBookingsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    void updateForm () {
      ...
      if (isValid) {
        ...
        bookingsData[i]=(Bookings(startofbooking: startofbooking, endofbooking: endofbooking, level: level, seatnumber: seatnumber, dateofbooking: dateofbooking));
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Update Booking of Seats',
          style: TextStyle(fontFamily: 'ITCKRIST', fontSize: 22),
        ),
      ),
      body: Container(
